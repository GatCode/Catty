...
- (void)binaryOperatorTest:(NSMutableArray *)internTokens withExpectedResult:(NSString *)result
{
    ...
    XCTAssertEqual([self.interpreter interpretInteger:formula forSpriteObject:[[SpriteObject alloc] initWithScene:[[Scene alloc] initWithProject:[[Project alloc] init]]]], [result intValue], @"Formula interpretation is not as expected!");
}
...
- (void)testUnaryMinus
{
    ...
    Formula *formula = [[Formula alloc] initWithFormulaElement:parseTree];
    XCTAssertEqual([self.interpreter interpretDouble:formula forSpriteObject:[[SpriteObject alloc] initWithScene:[[Scene alloc] initWithProject:[[Project alloc] init]]]], -42.42, @"Formula interpretation is not as expected");
}
...
- (void)testNot
{
    ...
    Formula *formula = [[Formula alloc] initWithFormulaElement:parseTree];
    XCTAssertEqual(0.0, [self.interpreter interpretDouble:formula forSpriteObject:[[SpriteObject alloc] initWithScene:[[Scene alloc] initWithProject:[[Project alloc] init]]]]);
    ...
    XCTAssertEqual([self.interpreter interpretDouble:formula forSpriteObject:[[SpriteObject alloc] initWithScene:[[Scene alloc] initWithProject:[[Project alloc] init]]]], 1.0);
    ...
    formula = [[Formula alloc] initWithFormulaElement:parseTree];
    XCTAssertEqual(1.0, [self.interpreter interpretDouble:formula forSpriteObject:[[SpriteObject alloc] initWithScene:[[Scene alloc] initWithProject:[[Project alloc] init]]]]);
}
