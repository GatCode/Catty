...
- (FormulaElement*)termForSpriteObject:(SpriteObject*)object
{
    ...
    switch (self.currentToken.internTokenType) {
        ...
        case TOKEN_TYPE_USER_VARIABLE: {
            UserVariable *variable = [object.project getUserVariableNamed:[self.currentToken getTokenStringValue] forSpriteObject:object inScene:nil];
        ...
        case TOKEN_TYPE_USER_LIST: {
            UserVariable *list = [object.project getUserListNamed:[self.currentToken getTokenStringValue] forSpriteObject:object inScene:nil];
